...
const CreatePost = () => {
  ...
  const formProgress = useMemo(() => {
    ...
    if (excerpt.trim()) completed++;
    if (content.trim()) completed++;
      ...
      <div className="relative container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="max-w-3xl mx-auto">
                ...
                <form onSubmit={onSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <CharacterCounter
                      ...
                      max={100}
                      label="Keep it concise and engaging"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <CharacterCounter
                      ...
                      max={200}
                      label="Ideal length: 100-150 characters"
                    />
                  </div>
                          ...
                          <div className="flex flex-wrap gap-2 pt-2">
                            {tags
                              ...
                              .map((tag, i) => (
                                <span
                                  key={i}
                                  className="text-xs px-2 py-1 bg-indigo-50 text-indigo-600 rounded-md"
                                >
                                  #{tag.trim()}
                                </span>
                              ))}
                  ...
                  <div className="flex flex-col sm:flex-row justify-end gap-3 pt-6 border-t border-slate-100">
                    ...
                    >
                      ...
                      <span
                        className={`relative flex items-center gap-2 px-6 py-3.5 rounded-xl font-semibold transition-all duration-200 ${
                          loading
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-5 bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Use a compelling title and write a clear excerpt for better
                    engagement.
                  </p>
                </div>
              </div>
